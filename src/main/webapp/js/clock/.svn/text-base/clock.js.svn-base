...
(function($) {
	$.fn.hoverclock = function(options) {
		...
		h_hoverClock.css({
			...
			"border-radius": settings.h_radius,
			"border": "solid 1px",
		...
		//--------------------------
		h_hoverClock.find(".hoverclocksecond-hand").css({
			"background-color": settings.h_secondHandColor
		})
		h_hoverClock.find(".hoverclockhour-text,.hoverclockminute-text").css({
			"color": settings.h_frontColor
		})
		h_hoverClock.find(".hoverclockfat-hand,.hoverclockminute-line").css({
			"background-color": settings.h_frontColor
		})
		h_hoverClock.find(".hoverclockthin-hand").css({
			"background-color": settings.h_thinHandColor
		})
		h_hoverClock.find(".hoverclocktext").css({
			"width": settings.h_width,
			"position": "absolute",
			"left": -h_hoverClock.width() / 2,
			"top": 500 / 20
		})
